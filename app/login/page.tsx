    ...
    <div className="min-h-screen bg-slate-100 flex items-center justify-center p-6">
      <div className="w-full max-w-[420px] bg-white rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.1)] p-10 border border-white">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-400 mt-2 font-medium">Masukkan kredensial Anda untuk masuk</p>
        </div>
        ...
        <div className="mt-8 text-center border-t border-gray-50 pt-6">
          <p className="text-sm text-gray-500 font-medium">
            Belum punya akun?{" "}
            <button className="text-blue-600 font-bold hover:underline">Daftar Gratis</button>
          </p>
        </div>
      </div>
    </div>
